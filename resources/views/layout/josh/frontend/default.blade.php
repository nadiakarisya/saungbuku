...
<head>
    ...
    <!--global css starts-->
    <link rel="stylesheet" type="text/css" href="{{ url('joshadmin/css/lib.css') }}">
    <!--end of global css-->
    <!--page level css-->
    @yield('header_styles')
...
<body>
    ...
    <header>
        ...
        <nav class="navbar navbar-default container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ route('home') }}"><img src="{{ url('joshadmin/images/logo.png') }}" alt="logo" class="logo_position">
                </a>
            </div>
            ...
            <div class="col-sm-4 right_float">
                ...
                <div class="media">
                    <div class="media-left media-top">
                        <a href="#">
                            <img class="media-object img-circle" src="{{ url('joshadmin/images/image_14.jpg') }}" alt="image">
                        </a>
                    </div>
                ...
                <div class="media">
                    <div class="media-left media-top">
                        <a href="#">
                            <img class="media-object img-circle" src="{{ url('joshadmin/images/image_15.jpg') }}" alt="image">
                        </a>
                    </div>
                    <div class="media-body">
                        <p class="media-heading">Lorem Ipsum is simply dummy text of the printing and type setting industry dummy.
                ...
                <div class="media">
                    <div class="media-left media-top">
                        <a href="#">
                            <img class="media-object img-circle" src="{{ url('joshadmin/images/image_13.jpg') }}" alt="image">
                        </a>
                    </div>
                    <div class="media-body">
                        <p class="media-heading">Lorem Ipsum is simply dummy text of the printing and type setting industry dummy.
                ...
                <div class="media">
                    <div class="media-left media-top">
                        <a href="#">
                            <img class="media-object img-circle" src="{{ url('joshadmin/images/c1.jpg') }}" alt="image">
                        </a>
                    </div>
                    <div class="media-body">
                        <p class="media-heading">Lorem Ipsum is simply dummy text of the printing and type setting industry dummy.
    ...
    {{--@endif--}}
    <!--global js starts-->
    <script type="text/javascript" src="{{ url('joshadmin/js/frontend/lib.js') }}"></script>
    <!--global js end-->
    <!-- begin page level js -->
