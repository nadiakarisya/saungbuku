...
class CsvSeeder extends Seeder
{
    ...
    private function insertRows()
    {
        ...
        try 
        {
            ...
            echo "inserting chunk = {$this->count} \n";

            $this->parsedData = [];

//            $this->chunk ++;
            // ZH
            $this->inserted += $this->count;
            $this->count = 0;
        }
        catch (\Exception $e)
        {
    ...
    {
        // ZH fix
        $this->console( $this->inserted.' of '.$this->total.' rows has been seeded in table "'.$this->tablename.'"' );
    }
